...
DEBUG = false; % true to plot the state of the drone, false otherwise
VIDEO = true; % true to record a video, false otherwise
CENTER_VIEW_ON_DRONE = false; % true to center the drone in the viewer, false otherwise 
...
for time =  p_sim.start_time:p_sim.dt:p_sim.end_time
    ...
    % Path manager and follower
    drone.manage_path(time);
    drone.follow_path();
